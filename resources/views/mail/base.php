                                ...
                                <tr>
                                    <td width="100%" style="text-align:left;background-color: #F7F7F9;">
                                        ...
                                        <p style="color:#474747; font-family:Arial, Helvetica, sans-serif; font-size: 14px; line-height: 22px; margin-top:0; margin-bottom:20px; padding:0; font-weight:normal;">
                                           Se ha creado una cuenta de {{getenv("APP_NAME")}}
                                        </p>
                                        <table bgcolor="#f4f4f4" border="0" cellspacing="0" cellpadding="25" width="100%" style="margin-bottom: 50px">
                                          <tr>
                                            <td style="padding: 30px">
                                              <div style="color:#e0ae43de; font-family:Arial, Helvetica, sans-serif; font-size: 27px; line-height: 27px; text-align: center;font-weight:bold; margin-bottom:0">
                                                Your first day is
                                              </div>
                                              <p style="color:#474747; font-family:Arial, Helvetica, sans-serif; font-size: 17px; text-align: center;font-weight:bold;">
                                                Monday, April 27, 2017 at 8:00 AM
                                              </p>
                                            <div style="color:#e0ae43de; font-family:Arial, Helvetica, sans-serif; font-size: 17px; line-height: 17px; text-align: center;font-weight:bold; margin-bottom:0">
                                                Location
                                              </div>
                                              <p style="color:#474747; font-family:Arial, Helvetica, sans-serif; font-size: 21px; text-align: center;font-weight:bold;">
                                                Ho Chi Minh City
                                              </p>
                                            </td>
                                          </tr>
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="emailwrapto100pc">
                                            <tr>
                                                <td class="emailcolsplit" align="left" valign="top" width="58%">
                                                    <p style="color:#474747; font-family:Arial, Helvetica, sans-serif; font-size:14px; line-height: 22px; margin-top:0; margin-bottom:20px; padding:0; font-weight:normal;">
                                                       We want you to started out right. Click 'Get Start' and we'll get you up and running at Cosipay
                                                    </p>
                                                    <a style="font-weight:bold; display: block; text-decoration:none; margin: 0 15px 20px; text-align: center;" href="#">
